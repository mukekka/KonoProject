...
//        数据库连接
        ...
        function registered($UserInfomation,$sqllink){
            ...
            $inSql =  mysqli_query($sqllink,$regHeadToSql);//写入头像
            con($inSql);
            alt('点击跳转至登录');
            $url = "Login.php";
